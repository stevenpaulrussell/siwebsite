...
from postoffice.cmdline import played_this_card                 # These urlpatterns move when viewer is separated
from postoffice.cmdline import return_playable_viewer_data      # These urlpatterns move when viewer is separated
from postoffice.cmdline import validate_passkey                 # These urlpatterns move when viewer is separated
