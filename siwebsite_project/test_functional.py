...
from postoffice.views import new_pobox_id
...
class OneCmdTests(TestCase):
    ...
    def test_cmd_messaging(self):
        ...
        item = Sender0.newsender_firstpostcard()
        print(f'\n Sender0.newsender_firstpostcard \n{item}\n')

        item = Sender1.newrecipient_postcard('twil1')
        print(f'\n Sender1.newrecipient_postcard \n{item}\n')



        item = Sender0.newpostcard_haveviewer('twil0')          # Twitalk sees morsel, so knows that pobox_id is established
        print(f'\n Sender0.newpostcard_haveviewer \n{item}\n')



        item = Sender1.passkey('twil0')
        print(f'\n Sender1.passkey \n{item}\n')
